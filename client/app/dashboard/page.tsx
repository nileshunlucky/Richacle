...
useEffect(() => {
  ...
  const fetchStrategies = async () => {
    try {
      const res = await fetch(`http://43.204.237.247:8000/user/${email}`);
...
useEffect(() => {
  ...
  try {
    const res = await fetch("http://43.204.237.247:8000/api/terminal", {
      method: "POST",
      body: form,
    });
...
const toggleEngine = async () => {
  ...
  try {
    const res = await fetch("http://43.204.237.247:8000/api/engine", {
      method: "POST",
      body: form,
    });
...
const handleStop = async (id: string) => {
  ...
  try {
    ...
    const res = await fetch(`http://43.204.237.247:8000/api/stop`, {
      method: "POST",
      body: form,
    });
...
const handleSquareOFF = async (id: string) => {
  ...
  try {
    ...
    const res = await fetch(`http://43.204.237.247:8000/api/squareoff`, {
      method: "POST",
      body: form,
    });
  ...
  const handleBinance = async () => {
    ...
    try {
      ...
      const res = await fetch("http://43.204.237.247:8000/api/binance", {
        method: "POST",
        body: form,
      });
  ...
  const handleDeploy = async (id: string, mode: string) => {
    ...
    try {
      ...
      const res = await fetch("http://43.204.237.247:8000/api/deploy", {
        method: "POST",
        body: form,
      });
